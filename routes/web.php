...
Route::middleware('guest:admin')->group(function () {
    Route::get("sifest2022/admin", [AdminAuthController::class, "create"])->name("admin");
    Route::post("sifest2022/admin", [AdminAuthController::class, "store"]);
});
...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::post("sifest2022/admin/logout", [AdminAuthController::class, "logout"])->name("admin_logout");
